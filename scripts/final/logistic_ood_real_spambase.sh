...
# [This script includes commands for the Spambase dataset. You can replace with spambase.]
...
#     --loss-save-path test_losses_spambase --device "cuda:0"
...
#     --optimizee-dir ./optimizees/matdata/logistic-spambase-rho1e-1 \
#     --optimizer AdaLISTA --layers 10 --init-lr 2e-3 --save-dir LogisticL1-AdaLISTA \
#     --input-dim 57 --output-dim 4601 --rho 1e-1 \
#     --test-size 1 --test-batch-size 1 --test-length 5000 \
#     --load-mat --load-sol --optimizee-dir ./optimizees/matdata/logistic-spambase-rho1e-1 \
#     --loss-save-path test_losses_spambase --device "cuda:0" \
#     --input-dim 57 --test-batch-size 1 --test-size 1
...
#     --loss-save-path test_losses_spambase --device "cuda:0" \
#     --input-dim 57 --test-batch-size 1 --test-size 1 --output-dim 4601
...
#     --save-dir LogisticL1-Adam --loss-save-path test_losses_spambase --device "cuda:0" \
#     --input-dim 57 --test-batch-size 1 --test-size 1 --output-dim 4601

# python main.py --config ./configs/logistic_testing.yaml --load-mat --load-sol \
#     --optimizee-dir ./optimizees/matdata/logistic-spambase-rho1e-1 \
#     --optimizer AdamHD --step-size 0.1 --momentum1 0.001 --momentum2 0.1 \
#     --hyper-step 1e-07 --save-dir LogisticL1-AdamHD --loss-save-path test_losses_spambase \
#     --device "cuda:0" \
#     --input-dim 57 --test-batch-size 1 --test-size 1 --output-dim 4601
...
python main.py --config ./configs/logistic_testing_wo_xk_set.yaml --r-use --q-use --b-use \
    ...
    --load-mat --load-sol --optimizee-dir ./optimizees/matdata/logistic-spambase-rho1e-1 \
    --loss-save-path test_losses_spambase --test-length 5000 \
    --device "cuda:0" \
    --input-dim 57 --test-batch-size 1 --test-size 1 --output-dim 4601