...
# python main.py --config ./configs/logistic_testing.yaml --p-use --a-use  \
#     --save-dir LogisticL1-L2O-PA --device "cuda:0" \
#     --load-mat --load-sol --optimizee-dir ./optimizees/matdata/logistic-rand \
#     --loss-save-path losses-rand-test --test-length 1000
